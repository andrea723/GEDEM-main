<header id="page-topbar">
        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('overview') }}" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{ URL::asset ('/assets/images/logoDamepay-dark.png') }}" alt="" height="40">
                    </span>
                </a>
                ...
                <a href="{{ route('overview') }}" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ URL::asset ('/assets/images/logoDamepay-light.png') }}" alt="" height="40">
                    </span>
                </a>
            </div>

            <button type="button" class="btn btn-sm px-3 font-size-16 header-item waves-effect d-block d-sm-none" id="vertical-menu-btn">
    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect"
                ...
                @switch(Session::get('lang'))
                    ...
                    @break
                    @case('cn')
                        <img src="{{ URL::asset('/assets/images/flags/china.jpg')}}" alt="Header Language" height="16"> <span class="align-middle">Chino</span>
                    @break
                    @default
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                <!-- item-->
                <a href="{{ url('index/cn') }}" class="dropdown-item notify-item language" data-lang="cn">
                    <img src="{{ URL::asset ('/assets/images/flags/china.jpg') }}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Chino</span>
                </a>
                <!-- item-->
        ...
        <button type="button" class="btn header-item noti-icon waves-effect ms-1">
            <i class="mdi mdi-book-education d-inline-block"></i>
            <span class="d-inline-block" key="t-henry"><a class="text-secondary" href="{{ route('documentation') }}" target="_blank">@lang('translation.Documentation')</a></span>
        </button>
     ...
     {{--    <div class="dropdown d-inline-block">
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="rounded-circle header-profile-user" src="{{ isset(Auth::user()->avatar) ? URL::asset('/storage/' . Auth::user()->avatar) : URL::asset('/assets/images/logo-light.png') }}"
                    alt="Header Avatar">
                <span class="d-none d-xl-inline-block ms-1" key="t-henry">{{ucfirst(Auth::user()->full_name)}}</span>
                <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
            </button>
            <div class="dropdown-menu dropdown-menu-end">
                <a class="dropdown-item d-block" href="{{ route('settingsGeneral') }}">
                ...
                <a class="dropdown-item">
                    <div class="form-check form-switch">
                        ...
                        <label class="form-check-label" for="light-mode-switch">@lang('translation.Light_Mode')</label>
                    </div>
                </a>
                <a class="dropdown-item">
                    <div class="form-check form-switch">
                        ...
                        <label class="form-check-label" for="dark-mode-switch">@lang('translation.Dark_Mode')</label>
                    </div>
                </a>
                <a class="dropdown-item">
                    <div class="form-check form-switch">
                        <input class="form-check-input theme-choice" type="checkbox" id="rtl-mode-switch" data-appStyle="assets/css/app-rtl.min.css">
                        <label class="form-check-label" for="rtl-mode-switch">@lang('translation.RTL_Mode')</label>
                    </div>
                </a>
                <div class="dropdown-divider"></div>
